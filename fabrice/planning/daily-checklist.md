...
### TikTok — Compte StoreMD (avec R) — 10 DMs
...
### Instagram — Compte StoreMD (avec R) — 10 DMs
...
### LinkedIn — Compte F perso — 10 connexions+DMs

- [ ] Récupérer les cibles LinkedIn via Apify (ou utiliser le recherche-log existant)
- [ ] Connexion+DM #1 à #10 (personnalisés, voir [cold-templates.md](http://cold-templates.md) section F)
...
- [ ] Répondre à TOUS les commentaires sur les posts publiés (F perso + StoreMD)
- [ ] Si un merchant veut tester → envoyer le lien d'installation beta en DM

### Vérifier publications

- [ ] Vérifier que le post Twitter F du jour est bien publié (schedulé samedi)
- [ ] Vérifier que le post LinkedIn F est bien publié (si mercredi ou vendredi)
...
| Cold Facebook (F perso) | 10 DMs/jour | 🔴 NON |
| Cold Twitter (F perso) | 10 DMs/jour | 🔴 NON |
| Cold LinkedIn (F perso) | 10 connexions+DMs/jour | 🔴 NON |
...
|-----------|--------|-----------|
| Twitter | F perso | 1/jour lun-ven |
| Twitter | StoreMD | 1/jour lun-ven |
| LinkedIn | F perso | mercredi, vendredi |
