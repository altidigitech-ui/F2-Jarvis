...
- Préparer le batch-semaine F (Twitter, LinkedIn, Reddit)
- Préparer le batch-semaine StoreMD avec R (Instagram, TikTok, Twitter StoreMD, Facebook, IH)
...
- Objectif : X beta testers installés (chiffre à définir)
...
| LinkedIn | F perso | 2/sem | mercredi, vendredi |
...
| Reddit | F perso | À déterminer | quand débloqué |
...
| Voix F | `[VOIX.md](http://VOIX.md)` |
| Batch-semaine perso F | `publication/[batch-semaine.md](http://batch-semaine.md)` |
