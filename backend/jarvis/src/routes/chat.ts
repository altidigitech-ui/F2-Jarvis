...
| "dispatch le batch S[N]" / "éclate le batch" / "génère les fichiers de publication" | → dispatch_batch(weekNumber) (éclatement en arrière-plan via le worker : le batch central S[N] est extrait en 3 fichiers de publication R / F / StoreMD, 3 actions create_file à valider quand prêtes) |
