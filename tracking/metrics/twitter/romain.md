# Twitter — Métriques compte R

> Source : Twitter Analytics → exports CSV (account overview, content, video overview)
> Compte : R (`@delgado_ro72224`)
> Mise à jour : chaque samedi par R, avant le batch de la semaine suivante.
> Template de collecte : voir `twitter-TEMPLATE.md` (même dossier, commun aux 3 comptes).
> Format date : JJ/MM/AAAA strict, partout.
> Convention période : telle qu'apparaît dans le nom de fichier CSV (typiquement lundi → dimanche).

---

## Semaine 9 — du 11/05/2026 au 17/05/2026

*Snapshot en attente — données à reporter ultérieurement.*
