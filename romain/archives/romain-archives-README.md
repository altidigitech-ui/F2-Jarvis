# Archives Romain — README local

> Agent local pour les archives vivantes de Romain.
...
Ce dossier contient les **archives vivantes** des activités hebdo de Romain :

- **Consultable rapidement** depuis le dossier `romain/` (baseline n-1, n-2, etc. pour comparaison entre semaines)
- **Vivantes** : reste à proximité du dossier actif tant qu'on est dans l'année en cours
- **Bascule en fin d'année** : toutes les `semaine-*-2026/` seront déplacées le **04/01/2027** vers `archives/2026/03-personas-hebdo/romain/` via le script de bascule annuelle (cf charte globale §2.6)
...
|-----------------|---------------|------------|----------------------|
| `progress.md` | `romain/tracking/progress-semaines.md` | **Toujours** | Template vide, nouveau header semaine N+1 |
| `plan-hebdo.md` | `romain/planning/plan-hebdo.md` | Si rempli pour la semaine | Template vide |
| `cold-log-twitter.md` | `romain/cold/cold-log-twitter.md` | Si activité dans la semaine | **Pas de reset** — append continu sur la source |
| `cold-log-linkedin.md` | `romain/cold/cold-log-linkedin.md` | Si activité dans la semaine | Pas de reset (append continu) |
| `cold-log-facebook.md` | `romain/cold/cold-log-facebook.md` | Si activité dans la semaine | Pas de reset (append continu) |
...
1. **Créer le dossier semaine** : `romain/archives/semaine-NN-DD-DD-mois-YYYY/`
2. **Archiver `progress.md`** : copie du contenu actuel de `romain/tracking/progress-semaines.md` → dossier semaine
...
5. **Reset des templates** :
   - `romain/tracking/progress-semaines.md` → template vide avec nouveau header semaine N+1
   - `romain/planning/plan-hebdo.md` → template vide avec nouveau header semaine N+1
...
**Destination :** `archives/2026/03-personas-hebdo/romain/`

**Avant la bascule** :
- Produire `romain/tracking/recap-2026.md` (compile les progress hebdo de l'année — events notables, analytics, décisions, learnings)
...
**Script** : voir charte globale §2.6 — `git mv romain/archives/semaine-*-2026/ archives/2026/03-personas-hebdo/romain/`
...
**Note pre-refonte** : le dossier `romain/archives/pre-refonte/` (ancienne structure pré-refonte du 06/05/2026) sera déplacé vers `archives/2026/05-dossiers-deprecated/pre-refonte-2026-05-06/romain/` lors de la Phase 2 du plan archivage. Il n'est pas listé dans l'index hebdo car ce n'est pas une archive de semaine.

---

*Fin du README local Romain. Voir `archives/README.md` pour la charte globale.*
