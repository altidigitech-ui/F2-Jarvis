...
4. Produire le post-mortem dans `tracking/decisions-log.md` (entrée YYYY-MM-DD-post-mortem-<slug>)
...
- **Archivé** dans `tracking/decisions-log.md` avec le préfixe `post-mortem-`
